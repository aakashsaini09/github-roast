...
export default function Hero() {
  return (
    <div className="font-second">
      ...
      <div className="w-full flex flex-col md:flex-row justify-evenly text-center font-semibold py-8 px-4">
      ...
      <h2 className="pt-40 mb-1 text-2xl tracking-tighter font-serif font-extrabold text-center text-gray-900 dark:text-gray-200 lg:text-7xl md:text-6xl">
        ...
        <br></br>
        <p className="mx-auto text-xl text-center text-slate-700 font-bold dark:text-gray-300 leading-relaxed fs521 lg:w-2/3">
        ...
        <div className="pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3">
          <div className="ktq4">
            ...
            <p className=" value-text text-md text-gray-200 fkrr1">
